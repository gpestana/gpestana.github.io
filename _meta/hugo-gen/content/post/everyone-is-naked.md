...
Note: Current CDNs do much more than only caching and distribution of online
...
Note: We use IPFS DHT as an example due to its stability, available tooling and APIs
